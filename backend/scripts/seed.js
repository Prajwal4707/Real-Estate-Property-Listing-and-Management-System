  ...
  try {
    ...
    const properties = [
      ...
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Magnificent villa in the prestigious Banjara Hills with panoramic city views and world-class amenities.",
        amenities: ["Swimming Pool", "Home Theater", "Wine Cellar", "Garden", "Servant Quarter", "Power Backup"],
        phone: "+91-900-000-1011",
        seeded: true,
      },
      {
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Luxury apartment overlooking Powai Lake with modern amenities and excellent connectivity.",
        amenities: ["Lake View", "Gym", "Swimming Pool", "Club House", "24/7 Security"],
        phone: "+91-900-000-1012",
        seeded: true,
      },
      {
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Affordable 2 BHK in Electronic City, perfect for IT professionals with easy access to tech parks.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1013",
        seeded: true,
      },
      {
        ...
        type: "House",
        availability: "For Sale",
        description: "Beautiful heritage bungalow in Civil Lines with colonial architecture and sprawling gardens.",
        amenities: ["Garden", "Servant Quarter", "Parking", "Security", "Heritage Features"],
        phone: "+91-900-000-1014",
        seeded: true,
      },
      {
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Premium apartment in the heart of Koregaon Park with modern amenities and excellent location.",
        amenities: ["Gym", "Swimming Pool", "Club House", "Parking", "24/7 Security"],
        phone: "+91-900-000-1015",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Stunning sea-facing villa in Goa with private beach access and tropical landscaping.",
        amenities: ["Sea View", "Private Beach Access", "Swimming Pool", "Garden", "Outdoor Kitchen"],
        phone: "+91-900-000-1016",
        seeded: true,
      },
      {
        title: "Premium Flat in Salt Lake City",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Spacious apartment in Salt Lake City with modern amenities and excellent connectivity.",
        amenities: ["Gym", "Parking", "Children's Play Area", "Club House", "24/7 Security"],
        phone: "+91-900-000-1017",
        seeded: true,
      },
      {
        title: "Luxury Penthouse in Baner",
        location: "Pune, Maharashtra",
        price: 45000000,
        image: [
        ...
        type: "Penthouse",
        availability: "For Sale",
        description: "Opulent penthouse in Baner with panoramic city views and luxurious amenities.",
        amenities: ["City View", "Private Terrace", "Swimming Pool", "Home Automation", "Servant Quarter"],
        phone: "+91-900-000-1018",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Contemporary villa in Sarjapur with modern architecture and premium finishes.",
        amenities: ["Swimming Pool", "Garden", "Home Theater", "Modular Kitchen", "Servant Quarter"],
        phone: "+91-900-000-1019",
        seeded: true,
      },
      {
        title: "Premium Apartment in Andheri West",
        location: "Mumbai, Maharashtra",
        price: 42000000,
        image: [
          "https://images.unsplash.com/photo-1574362848149-11496d93a7c7",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Well-maintained apartment in Andheri West with excellent connectivity to airport and metro.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1020",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Magnificent villa in Vasant Vihar with sprawling gardens and luxury amenities.",
        amenities: ["Garden", "Swimming Pool", "Home Theater", "Servant Quarter", "Security"],
        phone: "+91-900-000-1021",
        seeded: true,
      },
      {
        title: "Modern Flat in Hinjewadi",
        location: "Pune, Maharashtra",
        price: 18000000,
        image: [
          "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Affordable 2 BHK in Hinjewadi, perfect for IT professionals working in the area.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1022",
        seeded: true,
      },
      {
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Premium apartment in Whitefield with modern amenities and excellent connectivity.",
        amenities: ["Gym", "Swimming Pool", "Club House", "Parking", "24/7 Security"],
        phone: "+91-900-000-1023",
        seeded: true,
      },
      {
        title: "Heritage House in Fort Kochi",
        ...
        type: "House",
        availability: "For Sale",
        description: "Beautiful heritage house in Fort Kochi with colonial architecture and sea views.",
        amenities: ["Sea View", "Garden", "Heritage Features", "Parking", "Security"],
        phone: "+91-900-000-1024",
        seeded: true,
      },
      {
        title: "Premium Villa in Alibaug",
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Luxury villa in Alibaug with private beach access and panoramic sea views.",
        amenities: ["Sea View", "Private Beach Access", "Swimming Pool", "Garden", "Outdoor Kitchen"],
        phone: "+91-900-000-1025",
        seeded: true,
      },
      {
        title: "Modern Apartment in Sector 62",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Spacious apartment in Sector 62 with modern amenities and excellent connectivity.",
        amenities: ["Gym", "Parking", "Children's Play Area", "Club House", "24/7 Security"],
        phone: "+91-900-000-1026",
        seeded: true,
      },
      {
        ...
        type: "Penthouse",
        availability: "For Sale",
        description: "Ultra-luxury penthouse in Worli with panoramic sea and city views.",
        amenities: ["Sea View", "City View", "Private Pool", "Home Automation", "Servant Quarter"],
        phone: "+91-900-000-1027",
        seeded: true,
      },
      {
        title: "Premium Villa in Yelahanka",
        location: "Bengaluru, Karnataka",
        price: 42000000,
        image: [
          "https://images.unsplash.com/photo-1613977257363-707ba9348227",
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Beautiful villa in Yelahanka with modern amenities and spacious interiors.",
        amenities: ["Swimming Pool", "Garden", "Modular Kitchen", "Servant Quarter", "Security"],
        phone: "+91-900-000-1028",
        seeded: true,
      },
      {
        title: "Modern Flat in Kharadi",
        location: "Pune, Maharashtra",
        price: 22000000,
        image: [
          "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Well-designed 2 BHK in Kharadi with excellent connectivity to IT parks.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1029",
        seeded: true,
      },
      {
        title: "Luxury Apartment in Golf Course Road",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Premium apartment on Golf Course Road with luxury amenities and excellent location.",
        amenities: ["Gym", "Swimming Pool", "Club House", "Parking", "24/7 Security"],
        phone: "+91-900-000-1030",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Magnificent heritage villa in Udaipur with lake views and traditional architecture.",
        amenities: ["Lake View", "Garden", "Swimming Pool", "Heritage Features", "Servant Quarter"],
        phone: "+91-900-000-1031",
        seeded: true,
      },
      {
        title: "Modern Apartment in Wakad",
        location: "Pune, Maharashtra",
        price: 15000000,
        image: [
          "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Affordable 2 BHK in Wakad with modern amenities and good connectivity.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1032",
        seeded: true,
      },
      {
        ...
        type: "Penthouse",
        availability: "For Sale",
        description: "Ultra-luxury penthouse in Banjara Hills with panoramic city views.",
        amenities: ["City View", "Private Pool", "Home Automation", "Servant Quarter", "24/7 Security"],
        phone: "+91-900-000-1033",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Beautiful villa in Electronic City with modern amenities and spacious interiors.",
        amenities: ["Swimming Pool", "Garden", "Modular Kitchen", "Servant Quarter", "Security"],
        phone: "+91-900-000-1034",
        seeded: true,
      },
      {
        title: "Modern Flat in Andheri East",
        location: "Mumbai, Maharashtra",
        price: 35000000,
        image: [
          "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd",
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Well-maintained 3 BHK in Andheri East with excellent connectivity.",
        amenities: ["Gym", "Parking", "Children's Play Area", "24/7 Security"],
        phone: "+91-900-000-1035",
        seeded: true,
      },
      {
        ...
        type: "Apartment",
        availability: "For Sale",
        description: "Premium apartment in DLF Cyber City with luxury amenities and excellent location.",
        amenities: ["Gym", "Swimming Pool", "Club House", "Parking", "24/7 Security"],
        phone: "+91-900-000-1036",
        seeded: true,
      },
      {
        ...
        type: "Villa",
        availability: "For Sale",
        description: "Beautiful heritage villa in Jaipur with traditional architecture and modern amenities.",
        amenities: ["Garden", "Swimming Pool", "Heritage Features", "Servant Quarter", "Security"],
        phone: "+91-900-000-1037",
        seeded: true,
      },
    ].map(p => ({ ...p, seeded: true }));
