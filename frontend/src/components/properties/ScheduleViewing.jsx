...
const ScheduleViewing = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let errorMessage = "Error scheduling viewing"; // Handle specific error messages from backend
                        ...
                        >
                          ...
                          {timeSlots.map((slot) => (
                            <option
                              ...
                              value={slot}
                              disabled={
                                formData.date === dateRestrictions.min &&
                                isPastTime(slot)
                              }
                            >
                              {slot}
          ...
          {!isSuccess && (
            <div className="mt-6 pt-4 border-t border-gray-100">
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span>
                  A qualified agent will guide you through the viewing
                </span>
              </div>
            </div>
          )}
